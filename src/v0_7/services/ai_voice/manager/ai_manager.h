...
uint8_t ai_manager_cross_adv_selected_type_get();
bool ai_manager_cross_adv_is_ongoing_flag();
void ble_gva_ama_cross_adv_timer_start();
void ble_gva_ama_cross_adv_timer_stop();
#endif
