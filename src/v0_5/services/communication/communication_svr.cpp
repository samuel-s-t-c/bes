...
#if defined(CHIP_BEST1400) || defined(CHIP_BEST1402) || defined(CHIP_BEST2300P) || defined(CHIP_BEST1305)
...
int communication_io_mode_switch(enum COMMUNICATION_MODE mode)
{
    ...
    switch (mode)
    {
        ...
        #if defined(CHIP_BEST1400) || defined(CHIP_BEST1402) || defined(CHIP_BEST1305)
