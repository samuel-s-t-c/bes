...
int app_ibrt_voice_capture_trigger_init(void);
int app_ibrt_voice_capture_trigger_deinit(void);
void app_ibrt_voice_start_voice_stream_on_specific_ticks(uint32_t triggerTicks);
